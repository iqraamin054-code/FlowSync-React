    ...
    <section className="features-section reveal" id="features">
      <div className="container">
        <div className="section-header reveal">
          ...
          <h2 className="section-title section-title-center">Everything you need to scale</h2>
          <p className="section-desc">From project management to analytics, FlowSync gives your team the tools to move faster and ship smarter.</p>
        </div>
