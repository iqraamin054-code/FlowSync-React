          ...
          {plans.map((plan, pi) => (
            <div key={plan} className={`compare-mobile-card reveal${plan === 'Professional' ? ' compare-mobile-featured' : ''}`}>
              ...
              >
                ...
                <svg className={`compare-mobile-chevron${expanded === pi ? ' open' : ''}`} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9" /></svg>
              </button>
              <AnimatePresence>
                {expanded === pi && (
                  <motion.div
